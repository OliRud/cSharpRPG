...
namespace Engine
{
    public static class World //statis class can be accessed from anywhare (like a global)
    {
        //readonly variblaes accessible throughout the game
        ...
        //methods used to create the objects and add to the static lists
